        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div ref={buttonsRef} className="flex flex-col sm:flex-row gap-4 opacity-0">
              <button className="px-8 py-4 rounded-lg border-none shadow-lg flex items-center justify-center gap-2 group cursor-pointer transition-all text-lg font-semibold hover:shadow-xl hover:scale-105" style={{ backgroundColor: '#F4A940', color: 'white' }}>
